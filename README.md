...
This is how I like to construct objects and do inheritance.
  ...
  * **$new(prototype)** provide a prototype object for a new object instance. If an initialize function attribute exists it will be called then set to null.
...
### Pub/Sub
  * **$speak(obj)** Creates a new speaker (pub/sub). Optionally provide an object to turn into a speaker.
    ...
    * __stopListening(ignoreable)__ stop listening with (unsubscribe) the ignorable listener. If ignorable is expressed as a topoc string all listeners of topic will be removed. If a funciton is passed all listeners using that funciton will be removed.
